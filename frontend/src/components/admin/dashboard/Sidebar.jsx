...
import { FaBars, FaTimes, FaBook, FaSearch, FaHistory, FaPlus, FaClipboardList } from 'react-icons/fa'; // Icons for each menu item
  ...
  return (
    <div className="flex h-screen  bg-gray-100 overflow-hidden">
      ...
      <div className="flex-grow">
        ...
        {/* Main Content */}
        <div className="p-6 lg:ml-1/5 h-screen pb-20" style={{ overflow: 'scroll' }}>
          <Outlet />
        </div>
      </div>
    </div>
